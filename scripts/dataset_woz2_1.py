...
from .trie import Trie, get_trie, wozkgsort, get_kg_res
...
class BaseDataset(Dataset):
    ...
    def _prepare_conversations(self, dataset, split_type="train"):
    ...
    def _create_examples(self):
        ...
        for dialog in tqdm(self.dialogs):
            ...
            if kgdict_m != {} and kgdict_r != {}:
                all_kg = Trie()
                kgtrie = get_trie(kgdict_m, wozkgsort, all_kg, self.tokenizer)
                kgres = get_kg_res(kgdict_r, wozkgsort)
